...
class Client(object):
    ...
    def step(self):
        ...
        if self.in_http and len(self.inputdata) > 0:
            self.handshake()
            self.inputdata = ""
    ...
    #this will be called when the command "con" is received and will check user and pass for the user
